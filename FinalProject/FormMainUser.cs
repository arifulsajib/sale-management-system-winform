...
namespace FinalProject
{
    public partial class FormMainUser : Form
    {
        ...
        private void btnSales_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new UserChildForms.cFormUserSales());
        }
        ...
        private void btnAnalysis_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new UserChildForms.cFormUserAnalysis());
        }
        ...
        private void btnSettings_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new UserChildForms.cFormUserSettings());
        }
        ...
        private void btnDevinfo_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new UserChildForms.cFormUserDevInfo());
        }
